...
F           R_FLASH      FAT32          Removable Warning      Full Repair Needed       7.29 GB   7.29 GB
...
```bash
cd /mnt/<usb_drive_letter>
```

**6. Umount mass storage device, when not in use**

```bash
sudo umount /mnt/<usb_drive_letter>
sudo rm -rf /mnt/<usb_drive_letter>
```
